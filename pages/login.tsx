...
import Logo from "../components/icons/conf-plus-logo.png";
import { useMutation } from "react-query";
import { login } from "../utils/api/auth";
import type { Login } from "../utils/api/auth";
...
const Login: NextPage = () => {
  ...
  const invalidLogin = () => toast(error);
  ...
  return (
    <div className="bg-white py-6 sm:py-8 lg:py-12">
      <div className="max-w-screen-2xl px-4 md:px-8 mx-auto">
        <h1 className="text-gray-800 text-2xl lg:text-3xl font-bold text-center mb-4 md:mb-8 flex justify-center items-center">
          <span className="px-2">Conf</span>
          <Image src={Logo} width={50} height={50} />
          <span className="px-2">Plus</span>
        </h1>

        <h2 className="text-gray-700 text-xl lg:text-2xl font-bold text-center mb-4 md:mb-8">
          Login
        </h2>
