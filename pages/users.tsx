...
import AppTable, { AppTBody, AppTd, AppTr } from "../components/base/AppTable";
...
const Users: NextPage = () => {
  return (
    <div>
      <header className="text-gray-100 bg-gray-600 body-font">
        <div className="container mx-auto flex flex-wrap p-3 flex-col md:flex-row items-center">
          ...
          <div className="w-16 md:w-9 h-16 md:h-9 bg-gray-100 rounded-full overflow-hidden shadow-lg">
            <img
      ...
      <div className="flex">
        <aside className="sticky h-screen w-64" aria-label="Sidebar">
          <div className="overflow-y-auto py-4 px-3 h-full bg-gray-50 rounded-r dark:bg-gray-800">
